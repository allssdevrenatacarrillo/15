...
class ProjectProjectCustom(models.Model):
    ...
    # model_a_id = fields.Many2one('account.move', related='sale_line_id.order_id.invoice_ids', string='Model A')
    # model_a_id = fields.Many2one(related='sale_line_id.order_id.invoice_ids', string='Model A')
    model_a_id = fields.Many2one('project.project', related='sale_line_id.order_id.invoice_ids.id', string='Model A')
